...
export default function ThemeToggle() {
  // Initialize from <html data-theme="..."> (set by your pre-mount script), fallback to system
  ...
  const checked = theme === 'dark' // checked = night mode

  return (
    <label id="theme-toggle-button" className="theme-toggle-wrap" title="Toggle theme">
      <input
        type="checkbox"
        id="toggle"
        role="switch"
      ...
      />
      {/* From Uiverse.io by rishichawda (JSX-safe) */}
